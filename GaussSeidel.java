public class GaussSeidel {
    ...
    // Função para resolver sistema de equações usando o método de Gauss-Seidel
    public static double[] gaussSeidel(double[][] matrix, double epsilon, int maxIterations) {
        int n = matrix.length;
    ...
    public static void main(String[] args) {
        ...
        double[] solution = gaussSeidel(matrix, epsilon, maxIterations);
